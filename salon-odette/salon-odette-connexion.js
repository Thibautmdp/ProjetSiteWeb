/*
  ...
  - Correction faille : à l'inscription, le message d'erreur brut de Supabase
    ("User already registered") permettait de tester des emails un par un
    pour savoir lesquels ont déjà un compte client (énumération). Ce cas
    affiche maintenant le MÊME message que "compte créé, vérifiez votre
    email" — indistinguable de l'extérieur.
